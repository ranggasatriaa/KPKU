			...
			<div id="page-wrapper">
				<div class="row">
				  <div class="col-lg-12">
						...
						<p><a href="add_jenis_kerusakan.php?" class="btn btn-primary"><i class="fa fa-plus"></i>  Tambah Jenis kerusakan </a></p>
							<div class="row">
								<div class="col-lg-12">
									<!-- <div class="panel panel-default"> -->
										...
										<table class="table table-striped table-bordered table-hover" id="dataTables-example" align="left">
											...
											<?php
												...
												//Asign a query
												$query = " SELECT * FROM jenis_kerusakan ORDER BY idjenis_kerusakan ";
												// Execute the query
												...
												while ($row = $result->fetch_object()){
														echo '<tr>';
															...
															echo '<td>';
																echo '<a class="btn btn-warning" href="edit_jenis_kerusakan.php?id='.$row->idjenis_kerusakan.'"><i class="fa fa-edit"></i> Ubah</a>';
																echo '&nbsp&nbsp&nbsp<a class="btn btn-danger" href="delete_jenis_kerusakan.php?id='.$row->idjenis_kerusakan.'" onclick="return del()"><i class="fa fa-eraser"></i> Hapus</a>';
															echo '</td>';
														echo '</tr>';
														$i++;
												}
