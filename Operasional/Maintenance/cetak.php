    ...
    if (!$result_k || !$result_p){
      ...
      if(!$jumlah_k==0){
        ...
        while ($row_k = $result_k->fetch_object()){
          ...
          if ($row_k->status==1){
            $table->addRow();
              $table->addCell(4000, $styleCell)->addImage($row_k->direktori_kerusakan, array('width'=>200, 'height'=>170, 'align'=>'center'));
              $table->addCell(200, $styleCell);
              $table->addCell(4000, $styleCell)->addImage($row_k->direktori_perbaikan, array('width'=>200, 'height'=>170, 'align'=>'center'));
            $table->addRow();
            ...
            $table->addRow();
              $table->addCell(4000, $styleCell)->addImage($row_k->direktori_kerusakan, array('width'=>200, 'height'=>200, 'align'=>'center'));
              $table->addCell(200, $styleCell);
      ...
      if(!$jumlah_p==0){
        ...
        while ($row_p = $result_p->fetch_object()){
          $table = $section->addTable('TableStyle');
          $table->addRow();
            $table->addCell(4000, $styleCell)->addImage($row_p->direktori_kerusakan, array('width'=>200, 'height'=>170, 'align'=>'center'));
            $table->addCell(200, $styleCell);
            $table->addCell(4000, $styleCell)->addImage($row_p->direktori_perbaikan, array('width'=>200, 'height'=>170, 'align'=>'center'));
          $table->addRow();
