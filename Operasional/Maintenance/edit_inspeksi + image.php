		...
		<div id="wrapper">
	        ...
	        <div class="col-lg-12">
			      	...
			      	<h2 align="center"> Masukkan Detail Kerusakan </h2>
						...
						<form action="proses_edit_inspeksi.php" method="GET" enctype="multipart/form-data"/>
								<input type="hidden" name="id" value="<?php echo $idinspeksi;?>" />
								<input type="hidden" name="direktori_kerusakan" value="<?php echo $direktori_kerusakan;?>" />
								<input type="hidden" name="direktori_perbaikan" value="<?php echo $direktori_perbaikan;?>" />
									...
									<table>
										<tr>
											<td>
												...
												<br/><img id="img_prev" src="<?php echo $direktori_kerusakan;?>" style="width:40%; max-height:300px; min-width:100px; margin-bottom:5px"/>
												<input type="file" name="userfile_k" id="userfile_k">
											</td>
											<?php
												if ($status==1){
													// echo '<input type="hidden" name="direktori_perbaikan" value="';
													// echo $direktori_perbaikan'" />';
													echo '<td>';
													echo '<br/><img id="img_prev" src="'.$direktori_perbaikan.'" style="width:40%; max-height:300px; min-width:100px; margin-bottom:5px"/>';
													echo '<input type="file" name="userfile_p" id="userfile_p">';
													echo '</td>';
												}
											?>
										</tr>
