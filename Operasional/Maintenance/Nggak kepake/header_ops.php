        ...
        <div style="margin:0" class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
              ...
              <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Operasional<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                  <li>
                    <a href="/KPKU/Operasional/MA/index.php">MA</a>
                  </li>
                  <li>
                    <a href="/KPKU/Operasional/ME/index.php">ME</a>
                  </li>
                  <li>
                    <a href="/KPKU/Operasional/TM/index.php">TM</a>
                  </li>
                  <li>
                    <a href="/KPKU/Operasional/TC/index.php">TC</a>
                  </li>
                </ul>
                <!-- end -second-level -->
              </li>
              <li>
                <a href="#"><i class="fa fa-sitemap fa-fw"></i> Finance<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                  <li>
