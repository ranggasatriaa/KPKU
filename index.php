...
<html lang="en">
    ...
    <div class="container">
		...
		<!-- footer -->
		<!-- <div style="text-align:right; font-size:80%; height:40px; background:#0059B2; color:#cce6ff; position:fixed; bottom:0px; width:100%; padding:5px 20px; margin:10px 0px" >
