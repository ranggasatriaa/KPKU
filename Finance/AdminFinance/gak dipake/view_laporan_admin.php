			...
			<form  method="GET" autocomplete="on">
				<table align="center">
					<tr>
						...
						<td valign="top">:</td>
						<td valign="top"><select class="form-control" name="bulan">
							<?php
...
<?php
	...
	if(isset($_GET['submit'])){ //klo udah ngeklik bulan dan tahunnya
		...
		$query2 = " SELECT * FROM labarugi join tipe_anggaran on labarugi.tipe_anggaran =tipe_anggaran.id_tipe where labarugi.bulan=".$id_bulan." and labarugi.tahun =".$id_tahun." ORDER BY labarugi.tipe_anggaran ";
