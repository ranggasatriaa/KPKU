                ...
                <ul class="nav nav-second-level">
                  <li>
                    ...
                    <ul class="nav nav-third-level">
                      <li>
                        <a href="/KPKU/Finance/AdminFInance/view_grafik_anggaran.php">Dashboard</a>
                      </li>
                      <li>
                        <a href="/KPKU/Finance/AdminFinance/view_anggaran_admin.php">Laporan</a>
                      </li>
                    </ul>
                    <!-- /.nav-third-level -->
                  </li>
                  <li>
                    <a href="/KPKU/Finance/AdminFinance/add_tahun.php">Tambah Tahun</a>
                  </li>
                </ul>
                <!-- /.nav-second-level -->
              </li>
